...
./mvnw -pl dashpipe-api spring-boot:run -Dspring-boot.run.profiles=local,k8s
```
...
./mvnw -pl dashpipe-api test -Dtest=PipeletJobClientTest,PipeletJobManifestFactoryTest,PipelineRunOrchestratorTest,Fabric8PipeletJobClientIT
```
