...
| 2 | `./mvnw -pl dashpipe-api spring-boot:run -Dspring-boot.run.profiles=local` | App starts |
...
Run `./mvnw -pl dashpipe-api test` — WireMock + fixture tests green.
...
- [x] Parent `pom.xml` + `dashpipe-api` module
