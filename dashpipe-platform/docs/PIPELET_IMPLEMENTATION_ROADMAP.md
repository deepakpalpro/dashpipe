...
| Metadata | `pipelets/.../<id>/pipelet.json` (see PATHS.json) + [`dashpipe-ui/src/fixtures/pipelets.json`](../dashpipe-ui/src/fixtures/pipelets.json) |
| Binding | Step `connector_refs` → API injects `CONNECTOR_CONFIG` |
| Image | `dashpipe/<pipeletId>:<tag>` |
