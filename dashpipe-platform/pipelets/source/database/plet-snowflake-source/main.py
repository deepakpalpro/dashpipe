#!/usr/bin/env python3
"""plet-snowflake-source — generated runnable pipelet."""
...
def main() -> int:
    log("plet-snowflake-source starting")
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-snowflake-source")
