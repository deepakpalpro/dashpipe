#!/usr/bin/env python3
"""plet-nats-source — generated runnable pipelet."""
...
def main() -> int:
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-nats-source")
