#!/usr/bin/env python3
"""plet-redshift-destination — generated runnable pipelet."""
...
def main() -> int:
    log("plet-redshift-destination starting")
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-redshift-destination")
