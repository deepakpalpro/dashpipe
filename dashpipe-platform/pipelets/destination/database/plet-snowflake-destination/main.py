#!/usr/bin/env python3
"""plet-snowflake-destination — generated runnable pipelet."""
...
def main() -> int:
    log("plet-snowflake-destination starting")
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-snowflake-destination")
