#!/usr/bin/env python3
"""plet-clickhouse-destination — generated runnable pipelet."""
...
def main() -> int:
    log("plet-clickhouse-destination starting")
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-clickhouse-destination")
