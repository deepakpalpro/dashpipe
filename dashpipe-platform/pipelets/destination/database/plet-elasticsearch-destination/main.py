#!/usr/bin/env python3
"""plet-elasticsearch-destination — generated runnable pipelet."""
...
def main() -> int:
    log("plet-elasticsearch-destination starting")
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-elasticsearch-destination")
