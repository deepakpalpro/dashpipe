#!/usr/bin/env python3
"""plet-opensearch-destination — generated runnable pipelet."""
...
def main() -> int:
    log("plet-opensearch-destination starting")
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-opensearch-destination")
