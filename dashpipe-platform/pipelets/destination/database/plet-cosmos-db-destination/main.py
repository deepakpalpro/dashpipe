#!/usr/bin/env python3
"""plet-cosmos-db-destination — generated runnable pipelet."""
...
def main() -> int:
    log("plet-cosmos-db-destination starting")
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-cosmos-db-destination")
