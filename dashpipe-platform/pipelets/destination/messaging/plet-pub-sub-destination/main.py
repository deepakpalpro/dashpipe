#!/usr/bin/env python3
"""plet-pub-sub-destination — generated runnable pipelet."""
...
def main() -> int:
    log("plet-pub-sub-destination starting")
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-pub-sub-destination")
