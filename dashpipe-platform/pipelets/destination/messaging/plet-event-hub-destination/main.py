#!/usr/bin/env python3
"""plet-event-hub-destination — generated runnable pipelet."""
...
def main() -> int:
    log("plet-event-hub-destination starting")
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-event-hub-destination")
