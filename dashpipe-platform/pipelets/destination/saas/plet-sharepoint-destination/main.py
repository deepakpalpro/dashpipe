#!/usr/bin/env python3
"""plet-sharepoint-destination — generated runnable pipelet."""
...
def main() -> int:
    log("plet-sharepoint-destination starting")
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-sharepoint-destination")
