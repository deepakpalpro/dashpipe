#!/usr/bin/env python3
"""plet-schema-validator — generated runnable pipelet."""
...
def main() -> int:
    log("plet-schema-validator starting")
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-schema-validator")
