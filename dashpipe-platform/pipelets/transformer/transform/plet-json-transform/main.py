#!/usr/bin/env python3
"""plet-json-transform — generated runnable pipelet."""
...
def main() -> int:
    log("plet-json-transform starting")
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-json-transform")
