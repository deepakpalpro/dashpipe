#!/usr/bin/env python3
"""plet-pagerduty-destination — generated runnable pipelet."""
...
def main() -> int:
    log("plet-pagerduty-destination starting")
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-pagerduty-destination")
