#!/usr/bin/env python3
"""plet-regex-extract — generated runnable pipelet."""
...
def main() -> int:
    log("plet-regex-extract starting")
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-regex-extract")
