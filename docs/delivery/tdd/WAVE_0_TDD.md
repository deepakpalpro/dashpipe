...
| Unit | JUnit 5, AssertJ, WireMock | Every `./mvnw -pl dashflow-api test` | No Compose required |
...
1. `./mvnw -pl dashflow-api test` — unit + WireMock always; ITs skip cleanly without MySQL
...
|-------------------|--------|------|
| `TenantFixtures.T001` | tenant | `dashflow-api/src/test/resources/fixtures/tenants/t001.json` |
