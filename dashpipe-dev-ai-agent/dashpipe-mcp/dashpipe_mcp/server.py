...
from dashpipe_mcp.client import DashpipeApiError, DashpipeClient
...
_client: DashpipeClient | None = None
_catalog: PipeletCatalog | None = None


def _client() -> DashpipeClient:
    global _client
    if _client is None:
        _client = DashpipeClient(settings)
    return _client
