#!/usr/bin/env python3
"""plet-pub-sub-source — generated runnable pipelet."""
...
REQUIRED_EXECUTION = ('subscription',)
...
def main() -> int:
    log("plet-pub-sub-source starting")
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-pub-sub-source")
