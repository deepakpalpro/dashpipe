#!/usr/bin/env python3
"""plet-azure-blob-destination — generated runnable pipelet."""
...
def main() -> int:
    log("plet-azure-blob-destination starting")
    ...
    if isinstance(payload, str) and payload.startswith("run-"):
        message = {}
    out = run(message, execution, _connector(), "plet-azure-blob-destination")
