        ...
        .anySatisfy(
            row -> {
              ...
              assertThat(row.get("spiClass"))
                  .isEqualTo("com.dashflow.connector.rest.RestConnector");
            });
    assertThat(response.getBody())
        .anySatisfy(
            row -> {
              ...
              assertThat(row.get("spiClass"))
                  .isEqualTo("com.dashflow.connector.storage.StorageConnector");
            });
    assertThat(response.getBody())
        .anySatisfy(
            row -> {
              ...
              assertThat(row.get("spiClass"))
                  .isEqualTo("com.dashflow.connector.messagebus.MessageBusConnector");
            });
  }
}
